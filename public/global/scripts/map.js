...
var MapHelper = function () {
    ...
    var initMap2 = function (clickable, searchable, draggable, drawable) {
...
//                }]);
    ...
    var create_path = function (markers) {
        if (markers.length == 0) {
            var mapOptions = {
                center: new google.maps.LatLng(0000, 00),
                zoom: 10,
        ...
        //poly = new google.maps.Polyline({map: map, strokeColor: '#4986E7',path : markers});
    ...
    var drawPathRoute = function (markers) {
        var latlngbounds = new google.maps.LatLngBounds();
        var lat_lng = new Array();
        for (i = 0; i < markers.length; i++) {
            var data = markers[i]
...
//            document.getElementById('location').innerHTML = place.formatted_address;
    ...
    return {
        ...
        createPath: function (markers) {
            return create_path(markers);
        },
