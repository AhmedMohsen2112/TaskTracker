...
//                        text: message,
        ...
        uploaded_content: function (params) {
            ...
            if (delete_btn || view_btn) {
                ...
                if (edit_btn) {
                    html += '<a href="" data-id="' + id + '" onclick="Attachment.edit(this);return false;" class="icon-edit" title="">' +
        ...
        push_attachment: function (attachment_list) {
            if (Object.prototype.toString.call(attachment_list) === '[object Object]') {
                for (x in attachment_list)
                {
                    ...
                    if (x == 'gallery_image') {
                        ...
                        upload_input.closest('.form-group').find(".uploaded-images").append(items.join(' '));
                    } else {
                        var one = item_arr[0];
