...
if (!function_exists('modulesAsJson')) {

    function modulesAsJson() {
        $modules = config('settings.modules');
        $modules_arr_for_json = [];
        $count = 0;
        foreach ($modules as $module) {
            foreach ($module['actions'] as $action) {
                $modules_arr_for_json[$count] = $module['name'] . '_' . $action;
                $count++;
            }
        }
        return implode(',', $modules_arr_for_json);
    }
...
if (!function_exists('trans_rules')) {

    function trans_rules($columns_arr = array()) {
        $locales = Config::get('settings.locales');
        $rules = array();

        if (!empty($columns_arr)) {
            foreach ($columns_arr as $column => $rule) {
                foreach ($locales as $locale) {
                    $key = 'trans.' . $locale . '.' . $column;
                    $rules[$key] = $rule;
                }
            }
        }
...
if (!function_exists('url_public_path')) {

    function url_public_path($path = null) {
        return url("public");
    }
...
if (!function_exists('url_upload_path')) {

    function url_upload_path($path = null) {
...
if (!function_exists('admin_scripts')) {
    ...
    function admin_scripts($path = null) {
        return url("public/admin/scripts/$path");
    }

}
if (!function_exists('seller_scripts')) {

    function seller_scripts($path = null) {
        return url("public/admin/scripts/seller/$path");
    }

}
if (!function_exists('front_scripts')) {

    function front_scripts($path = null) {
        return url("public/front/scripts/$path");
    }

}
if (!function_exists('global_scripts')) {

    function global_scripts($path = null) {
        return url("public/global/scripts/$path");
    }

}
if (!function_exists('global_plugins')) {

    function global_plugins($path = null) {
        return url("public/plugins/$path");
    }

}
if (!function_exists('admin_img')) {

    function admin_img($path = null) {
        return url("public/admin/img/$path");
    }

}
if (!function_exists('front_img')) {

    function front_img($path = null) {
        return url("public/front/img/$path");
    }

}
if (!function_exists('admin_plugins')) {

    function admin_plugins($path = null) {
        return url("public/plugins/$path");
    }

}
if (!function_exists('front_plugins')) {

    function front_plugins($path = null) {
        return url("public/plugins/$path");
    }
...
if (!function_exists('admin_css')) {
    ...
    function admin_css($path = null) {
        return url("public/admin/css/$path");
    }

}
if (!function_exists('front_css')) {

    function front_css($path = null) {
        return url("public/front/css/$path");
    }

}
if (!function_exists('front_js')) {

    function front_js($path = null) {
        return url("public/front/js/$path");
    }
...
if (!function_exists('apanel_url')) {

    function apanel_url($path = null, $parameters = [], $secure = null) {
        $path = 'apanel/' . $path;
        if (is_null($path)) {
            return app(UrlGenerator::class);
        }
...
if (!function_exists('t')) {
    ...
    function t($string, $replace = [], $file = 'app', $locale = null) {
        ...
        if (Lang::has($item)) {
            ...
            $line = str_replace('_', ' ', ucwords($string));
        }
        return $line;
    }
...
if (!function_exists('currency')) {
    ...
    function currency($price = NULL) {
        ...
        if (request()->hasCookie('DefaultCurrency')) {
            $return = Cookie::get('DefaultCurrency');
        }
        if ($price) {
...
if (!function_exists('_json')) {
    ...
    function _json($type = 'success', $data = NULL, $http_code = 200, $return_data = false) {
        $json = array();
        if ($return_data) {
            $json = $data;
        } else {
...
if (!function_exists('GetDays')) {
    ...
    function GetDays($startDate, $endDate, $format = "Y-m-d") {
        ...
        $Days[] = date($format, strtotime($startDate));
        ...
        while ($currentDate < $endDate) {
            ...
            $Days[] = date($format, strtotime($currentDate));
...
if (!function_exists('_buildTreeWithOption')) {

    function buildTreeWithOption($elements, $parentId = 0) {
        $html = '';
        foreach ($elements as $element) {
            //dd($elements);
            if ($element->parent_id == $parentId) {
                $html .= '<option value="' . $element->id . '">' . $element->repeat_title . '</option>';
                $children = buildTreeWithOption($elements, $element->id);
